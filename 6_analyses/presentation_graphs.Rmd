...
ggsave("k3_winter_effect_scatterplot.png", width = 15, units = "cm", dpi = 300)
```
...
joined_clustered %>% 
  ...
  labs(y = "Median eergy consumption (kWh)", x = "Date", title = "Median energy consumption by cluster") +
  theme_cc_final_project() +
  scale_colour_manual(values = c("#15487a", "#611bb8", "#65a346")) +
  facet_wrap(~ cluster, ncol = 1)

ggsave("three_clusters_ts.png", width = 15, units = "cm", dpi = 300)
```
